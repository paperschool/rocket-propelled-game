...
import { homeRoomCodeInput } from './index.scss';
...
const HomeJoinRoom: FunctionComponent = () => {
    ...
    return (
        <div className={homeRoomCodeInput}>
            <SmallHeader heading={'Enter Room Code'} subHeading={'Enter a Room Code if you have one!'} />
            <Input
                onChange={(input) => {
